...
#include <memory>
#include "../../FastFoodApp/tileview.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_TileView_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_TileView_t qt_meta_stringdata_TileView = {
    {
QT_MOC_LITERAL(0, 8) // "TileView"
...
const QMetaObject TileView::staticMetaObject = { {
    ...
    qt_meta_stringdata_TileView.offsetsAndSize,
    qt_meta_data_TileView,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_TileView_t
, QtPrivate::TypeAndForceComplete<TileView, std::true_type>
